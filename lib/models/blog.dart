...
class Blog {
  ...
  User? writer; // Penulis
  String? banner; // Gambar banner atau sampul, sementara dari local
  ...
  static List<Blog> blogs = [
    ...
    Blog(
      ...
      banner: 'assets/banner/himatif.jpg'
    ),
    Blog(
      id: _generateRandomId(),
    ...
    Blog(
      ...
      banner: 'assets/banner/seele.jpg'
    ),
  ];
